...
const S = {
  ...
  hero:{ minHeight:"100vh", display:"flex", alignItems:"flex-start", justifyContent:"center", padding:"5.5rem 3rem 3rem", position:"relative", overflow:"hidden" },
  ...
  heroInner:{ position:"relative", zIndex:2, maxWidth:"800px", textAlign:"center", paddingTop:"1.5rem" },

  provBox:{ display:"flex", flexDirection:"column", alignItems:"center", gap:"0.3rem", padding:"1rem 1.8rem", background:GB, border:`1px solid ${GD}`, maxWidth:"600px", margin:"0 auto 1.5rem" },
  provYoruba:{ fontFamily:"Georgia,serif", fontSize:"0.88rem", fontStyle:"italic", color:G, lineHeight:1.55 },
  provEng:{ fontSize:"0.76rem", color:M, fontStyle:"italic" },
  provSrc:{ fontFamily:"monospace", fontSize:"0.56rem", letterSpacing:"0.15em", textTransform:"uppercase", color:M, opacity:0.7 },

  h1:{ fontFamily:"Georgia,serif", fontSize:"clamp(2.6rem,6.5vw,5rem)", fontWeight:300, lineHeight:1.06, letterSpacing:"-0.02em", marginBottom:"1.2rem" },
